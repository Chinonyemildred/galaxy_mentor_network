<template>
     <Layout>
      ...
      <b-col lg="5" md="5">
          ...
          <h2>Mentorship Training</h2>
          <p>We encourage all participants to watch this video on open source mentorship.</p>
          ...
          <p>Video credit: MongoDB</p>
          <p>More information to guide you can be found in this <a href="https://www.mentorship.guide/">resource</a></p>
...
<page-query>
query {
    main: insert (path: "/content/mentorship/") {
        id
        title
        content
        fileInfo {
